    ...
    return {
      ...
      link:function(scope, element, attribute) {
        $('.card').click (function () {
          ...
          $(this).find('.card__bannerPreview--heading').animate({top: '-150px'});
  ...
  return {
    ...
    link:function(scope, element, attribute) {
      $('.closepls').click(function () {
        $('.card').removeClass('thisactivecard'), 20;
        $('.card__bannerPreview--bannerImg').animate({height: '160px', width: '100%', borderRadius: '0px', margin: '0', position: 'relative', top: '0'},{ duration: 10, queue: false });
      })
    }
  }
})
